...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Search", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.white,),),
      ),
      body: Column(
        children: [
          Container(
    ...
    return hasUserSearch
      ? ListView.builder(
          ...
          itemBuilder: (context, index){
            return groupTile(
              userName, searchSnapshot!.docs[index]['groupId'], searchSnapshot!.docs[index]['groupName'], searchSnapshot!.docs[index]['admin']
            );
          }
        )
      : Container();
  ...
  Widget groupTile(String userName, String groupId, String groupName, String admin){
    // function to check weather user already exist in group
      ...
      trailing: InkWell(
        onTap: ()async{
          ...
          if(isJoined){
            ...
            showSnackBar(context, Colors.green, "Successfully joined the group", "Ok");
            ...
            showSnackBar(context, Colors.red, "Left the group $groupName", "Ok");
          }
        },
        child: isJoined
          ? Container(
